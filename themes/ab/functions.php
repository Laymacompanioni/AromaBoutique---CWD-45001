<?php
/**
 * Aroma Boutique functions and definitions
 *
...
function ab_setup() {
	/*
		...
		* If you're building a theme based on Aroma Boutique, use a find and replace
...
function ab_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'ab_content_width', 640 );
}
...
function ab_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'ab' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'ab' ),
 ...
 */
function ab_scripts() {
	wp_enqueue_style( 'ab-style', get_stylesheet_uri(), array(), AB_VERSION );
